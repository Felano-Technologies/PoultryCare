  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        } md:relative md:translate-x-0 transition-transform duration-200 ease-in-out mt-16 h-[calc(100vh-4rem)]`}>
        ...
        {/* Main Content */}
        <div className="flex-1 flex flex-col overflow-hidden mt-16 h-[calc(100vh-4rem)]">
          {/* Chat Area */}
          <main 
